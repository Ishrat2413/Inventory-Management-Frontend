...
import { DEMO_CREDENTIALS } from "@/constants/nav";
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={fillDemo}
        className="border-border bg-muted/50 hover:bg-muted text-muted-foreground rounded-lg border border-dashed px-3 py-2.5 text-center text-xs transition-colors cursor-pointer"
      >
        Use demo credentials — <span className="tabular font-medium">admin@example.com / admin123</span>
      </button>
    </motion.form>
  );
}
