...
import { useVendorsList, useCreateVendor, useUpdateVendor, useDeleteVendor } from "@/hooks/queries/use-vendors";
...
export function VendorsTable() {
  ...
  const { data, isLoading } = useVendorsList({ searchKey: search || undefined });
